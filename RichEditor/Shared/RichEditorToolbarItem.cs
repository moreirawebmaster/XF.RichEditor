...
{
    public class ToolbarBuilder : List<RichEditorToolbarItem>
    {
        ...
        private void AddOnce(RichEditorToolbarItem item)
        {
            if (Count == 0)
            {
                Add(item);
    ...
    public class RichEditorToolbarItem
    {
        public string ImagePath { get; set; }

        public string Label { get; set; }

        public Func<IRichEditorApi, string> ClickFunc { get; set; }
    }
}